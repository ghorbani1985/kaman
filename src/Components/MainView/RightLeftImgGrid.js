...
function RightLeftGrid(props) {
  return (
    <div className="container grid grid-cols-12 gap-5 items-center justify-center bg-gradient-to-r from-blue-50 via-white to-blue-50 p-4 dark:bg-slate-500 my-8">
