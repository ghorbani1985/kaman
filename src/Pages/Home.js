...
import Card from '../Components/MainView/Card';
function Home() {
    ...
    <>
      <main className="container">
        <div className="grid grid-cols-12 gap-5">
          ...
          <div className="col-span-12 md:col-span-6 perfectCenter w-full h-full lg:col-span-7 shadow-[6px_73px_62px_rgb(0,12,119,3%)] rounded-full">
            <img
              src={homeLeft}
              alt="homeLeft"
